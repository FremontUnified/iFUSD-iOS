...
- (iRate *)init
{
	if ((self = [super init]))
	{
        ...
        self.applicationName = @"FUSD for iOS";
...
- (void)alertView:(UIAlertView *)alertView didDismissWithButtonIndex:(NSInteger)buttonIndex
{
	if (buttonIndex == alertView.cancelButtonIndex)
	{
	    ...
	    [FlurryAnalytics logEvent:@"Declined Rating"];
	...
	else if (buttonIndex == 2)
	{
        ...
        [FlurryAnalytics logEvent:@"Said Later"];
	...
	else
	{
        ...
        [FlurryAnalytics logEvent:@"Did Agree to Rate"];
